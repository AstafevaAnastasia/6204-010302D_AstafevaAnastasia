...
public class CompositeFunctionTest {
    ...
    double[] yValuesCos2 = {-1.0, -0.5, -0.5, 0, 0, 0.5, 0.5, 1.0, 1.0};
    ...
    public void testApply() {
        // Тесты для списка
        assertEquals(0.4098593171027442,  ((LinkedListTabulatedFunction)testFunction1).apply( 2), 0.1);
        assertEquals(0.4098593171027442,  ((LinkedListTabulatedFunction)testFunction2).apply(2), 0.1);
        //для массива
        assertEquals(0.4098593171027442,  ((ArrayTabulatedFunction)testFunction3).apply( 2), 0.1);
        assertEquals(0.4098593171027442,  ((ArrayTabulatedFunction)testFunction4).apply(2), 0.1);
    }
    ...
    public void testInterpolate() {
        ...
        assertEquals(-0.5373375328256039, ((LinkedListTabulatedFunction) testFunction1).interpolate(1.0, floorIndex1), 0.1);
        assertEquals(-0.0901406828972558, ((LinkedListTabulatedFunction) testFunction2).interpolate(1.0, floorIndex2), 0.1);
        assertThrows(IllegalArgumentException.class, () -> ((LinkedListTabulatedFunction) testFunction1).interpolate(1.5, -1));
        //для массива
        assertEquals(-0.5373375328256039, ((ArrayTabulatedFunction) testFunction3).interpolate(1.0, ((ArrayTabulatedFunction) testFunction3).floorIndexOfX(1.0)), 0.1);
        assertEquals(-0.0901406828972558, ((ArrayTabulatedFunction) testFunction4).interpolate(1.0, ((ArrayTabulatedFunction) testFunction4).floorIndexOfX(1.0)), 0.1);
    ...
    public void testRemove(){
        ...
        assertEquals(0.0, ((LinkedListTabulatedFunction) testFunction2).getY(2), 0.0001);
        ...
        assertEquals(0.0, ((ArrayTabulatedFunction) testFunction4).getY(2), 0.0001);
    }
}